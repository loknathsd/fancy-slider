...
//keyboard enter button  search input 
...
sliderBtn.addEventListener('click', function () {
  ...
  if (duration > 0) {
    ...
    document.getElementById('durationError').innerText = `Please Enter duration value `;

  };
});

//keyboard enter button slider input
